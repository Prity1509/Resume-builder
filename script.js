...
//   project section
const maxNewSections = 2;
let currentNewSections = 0;

function addProject() {
  if (currentNewSections < maxNewSections) {
    const newSection = document.createElement('div');
    newSection.innerHTML = `
      <span><input type="checkbox" class="input-checkbox"></span>
      <span class="title" contenteditable="true">New project ${currentNewSections + 1}</span>
      <br>
      <br>
      <div class="project-title" contenteditable="true">Write your project title here</div>
      <div class="project-description" contenteditable="true">Write your project description here</div>
      <div class="project-technologies" contenteditable="true">Write the technologies used here, separated by commas</div>
      <div class="project-link" contenteditable="true">Add a link to your project here</div><br><br>
    `;
    document.getElementById('projects').appendChild(newSection);
    currentNewSections++;
  } else {
    alert('Atmost 2 NEW SECTION can be added!');
  }
